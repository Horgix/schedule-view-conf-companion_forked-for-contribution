...
.Agile, .Produit, .Green, .Stratégie, .Product{
  ...
  background-color: fade-out($product, 0.8);
  &:hover{
...
.Experience, .Design, .UX, .UI {
  ...
  background-color: fade-out($experience, 0.8);
  &:hover{
...
.Mobile, .Engineering, .Craft, .Sécurité, .Cloud {
  ...
  background-color: fade-out($engineering, 0.8);
  &:hover{
...
.Data, .AI {
  ...
  background-color: fade-out($data, 0.8);
  &:hover{
...
.AI {
  background-image: url('data:image/svg+xml;utf8,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20126%2069%22%20width=%22126%22%20height=%2269%22%20style=%22opacity:%200.5;%22%3E%3Ctext%20x=%220em%22%20y=%221em%22%20font-size=%2230%22%3E%E2%9C%A8%3C/text%3E%3Ctext%20x=%221em%22%20y=%222em%22%20font-size=%2230%22%3E%E2%9C%A8%3C/text%3E%3Ctext%20x=%222em%22%20y=%221em%22%20font-size=%2230%22%3E%E2%9C%A8%3C/text%3E%3Ctext%20x=%223em%22%20y=%222em%22%20font-size=%2230%22%3E%E2%9C%A8%3C/text%3E%3C/svg%3E');
